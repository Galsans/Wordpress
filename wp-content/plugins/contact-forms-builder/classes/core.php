        ...
        <form method="post" action="admin.php?page=wpda_form_uninstall" style="width:99%;">
			 <?php wp_nonce_field('wpdevartForms_uninstall','wpdevartForms_uninstall_bad'); ?>
              <div class="wrap">
                ...
                <p>
                  Deactivating WpDevArt Forms plugin does not remove any data that may have been created. To completely remove this plugin and all created forms data, you can uninstall it here.
                </p>
                <p style="color: #bf1f1f;font-weight: bold;">
