...
<header class="header">
	...
	<?php
		if( wp_get_theme() == 'wpdevart' || wp_get_theme() == 'wpdevart Child' || wp_get_theme() == 'wpdevart Theme' || wp_get_theme() == 'wpdevart Child Theme' ) {
				//	If WpDevArt contact form theme is active, then it will not add sidebar menu because
				//	WpDevArt form theme automatically add sidebar menu items under WpDevArt tab
	?>
    <div class="lower-bar">
